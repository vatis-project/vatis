...
public class SandboxViewModel : ReactiveViewModelBase
{
    ...
    {
        get => _atisBuilderResponse;
        set => this.RaiseAndSetIfChanged(ref _atisBuilderResponse, value);
    }
    #endregion
    ...
    private async Task HandleRefreshSandboxAtis()
    {
        try
        {
            ...
            if (SandboxMetar != null)
            {
                ...
                AtisBuilderResponse = await _atisBuilder.BuildAtis(SelectedStation, SelectedPreset, randomLetter,
