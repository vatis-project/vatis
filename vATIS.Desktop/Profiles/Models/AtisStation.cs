...
{
    private List<ContractionMeta> contractionMetas = [];
    ...
    {
        get => this.contractionMetas;
        set
        {
            this.contractionMetas = [];
            foreach (var contractionMeta in value)
            {
                ...
                this.contractionMetas.Add(contractionMeta);
            }
        }
    }
    ...
    /// </summary>
    [JsonIgnore]
    public bool IsFaaAtis => this.Identifier.StartsWith('K') || this.Identifier.StartsWith('P');
