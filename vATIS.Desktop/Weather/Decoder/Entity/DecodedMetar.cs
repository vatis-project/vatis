// <copyright file="DecodedMetar.cs" company="Justin Shannon">
...
{
    private readonly string? rawMetar;

    /// <summary>
    /// Decoding exceptions, if any.
    /// </summary>
    private List<MetarChunkDecoderException> decodingExceptions = [];
    ...
    {
        get => this.rawMetar?.Trim();
        private init => this.rawMetar = value;
    }

    /// <summary>
    /// Gets decoding exceptions, if any.
    /// </summary>
    public ReadOnlyCollection<MetarChunkDecoderException> DecodingExceptions => new(this.decodingExceptions);
    ...
    /// </summary>
    public bool IsValid => this.DecodingExceptions.Count == 0;
    ...
    {
        this.decodingExceptions = new List<MetarChunkDecoderException>();
    }
    ...
    {
        this.decodingExceptions.Add(ex);
    }
}
